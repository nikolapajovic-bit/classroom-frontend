...
const DepartmentShow = () => {
    ...
    const subjectColumns = useMemo<ColumnDef<DepartmentSubject>[]>(() => [
        ...
        },
        {
            ...
            cell: ({ getValue }) => 
                <span className="text-muted-foreground ml-2">{getValue<string>()}</span>
        },
        {
            id: 'description',
            ...
            cell: ({ getValue }) => {
                ...
                return description ? (
                    ...
                    <span className="text-muted-foreground ml-2">No description</span>
                )
            }
        },
        {
        ...
        return (
            <ShowView className="class-view">
                ...
                <p className="text-sm text-muted-foreground">
                    {query.isLoading ? "Loading department details..." : query.isError ? "Failed to load department details." : "Department details not found."}
                </p>
            </ShowView>
        )
    }
